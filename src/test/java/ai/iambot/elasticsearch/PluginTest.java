...
public class PluginTest {
    ...
    private void testDifferentVectors(String s, String s2) throws IOException {
    ...
    public void test() throws Exception {
        testDifferentVectors("cosine", "0.1, 0.2, 0.3");
    }

    @Test
    public void testTSSSDifferentVectors() throws Exception {
        testDifferentVectors("tsss", "0.1, 0.2, 0.3");
    }

    @Test
    public void testTSSSSameVectors() throws Exception {
        testDifferentVectors("tsss", "0.2, 0.6, 0.99");
    }

    @Test
    public void testChiSquared() throws Exception {
        testDifferentVectors("chisquared", "0.1, 0.2, 0.3");
    }

    @Test
    public void testEuclidean() throws Exception {
        testDifferentVectors("euclidean", "0.1, 0.2, 0.3");
    }
